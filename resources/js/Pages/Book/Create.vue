                    ...
                    <div class="border-b border-gray-900/10 pb-12">
                        ...
                        >
                            <div class="sm:col-span-4">
                                ...
                                <p class="mt-2 text-sm text-red-600" v-if="errors.author">{{ errors.author }}</p>
                            </div>
                        </div>
                        ...
                        >
                            <div class="sm:col-span-4">
                                ...
                                <div class="mt-2">
                                    ...
                                    <p class="mt-2 text-sm text-red-600" v-if="errors.publication_year">{{ errors.publication_year }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
